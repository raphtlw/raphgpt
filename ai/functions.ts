...
export const functions = hyperStore<ContextType>({
  ...
  search_google: hyper({
    description:
      "Get relevant search results from Google in JSON format. Use this to answer questions that require browsing the web/up to date info, or to get links from web results.",
    args: {
